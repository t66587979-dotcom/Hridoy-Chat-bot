...
module.exports.config = {
  ...
  description: "Random Japanese girl picture",
...
module.exports.run = async function ({ api, event }) {
  ...
  const imgPath = path.join(cacheDir, `japan_${Date.now()}.jpg`);

  try {
    const loading = await api.sendMessage("⏳ জাপানি গার্ল লোড হচ্ছে...", threadID);
    ...
    await api.sendMessage(
      {
        body: `💖 Japanese Girl 💖\n🖼️ Total: ${links.length}\n\nআবার চাইলে japan লেখো`,
    ...
    api.sendMessage("❌ ছবি পাঠানো যায়নি, আবার চেষ্টা করো।", threadID, messageID);
  }
};
